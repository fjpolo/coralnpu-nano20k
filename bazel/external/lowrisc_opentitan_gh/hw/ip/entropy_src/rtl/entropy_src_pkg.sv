...
package entropy_src_pkg;
  ...
  localparam int  CSRNG_BUS_WIDTH = 384;
  localparam int  FIPS_BUS_WIDTH  = 1;
  localparam int  FIPS_CSRNG_BUS_WIDTH = FIPS_BUS_WIDTH + CSRNG_BUS_WIDTH;
  ...
  localparam int BucketHtDataMaxWidth = 4;
  ...
  localparam entropy_src_hw_if_req_t ENTROPY_SRC_HW_IF_REQ_DEFAULT = '{default: '0};
  localparam entropy_src_hw_if_rsp_t ENTROPY_SRC_HW_IF_RSP_DEFAULT = '{default: '0};
  ...
  localparam cs_aes_halt_req_t CS_AES_HALT_REQ_DEFAULT = '{default: '0};
  localparam cs_aes_halt_rsp_t CS_AES_HALT_RSP_DEFAULT = '{default: '0};
  ...
  localparam entropy_src_xht_meta_req_t ENTROPY_SRC_XHT_META_REQ_DEFAULT = '{default: '0};
  localparam entropy_src_xht_meta_rsp_t ENTROPY_SRC_XHT_META_RSP_DEFAULT =
