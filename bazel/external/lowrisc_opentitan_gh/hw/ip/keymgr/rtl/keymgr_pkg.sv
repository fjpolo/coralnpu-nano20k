...
package keymgr_pkg;
  ...
  localparam int CDIs = 2; // 2 different CDIs, sealing / attestation
  localparam int CdiWidth = prim_util_pkg::vbits(CDIs);
  localparam int OtbnKeyWidth = 384;
  ...
  localparam int SwBindingWidth = 32 * keymgr_reg_pkg::NumSwBindingReg;
  localparam int SaltWidth = 32 * keymgr_reg_pkg::NumSaltReg;
  localparam int Shares = 2; // number of key shares
  localparam int EdnWidth = edn_pkg::ENDPOINT_BUS_WIDTH;
  localparam int KeyVersionWidth = 32;  // Key version length for individual DICE stage
  ...
  localparam lfsr_seed_t RndCnstLfsrSeedDefault = 64'h22d326255bd24320;
  ...
  localparam int KDFMaxWidth = 1984;
  ...
  localparam hw_key_req_t HW_KEY_REQ_DEFAULT = '{
    valid: 1'b0,
    key: {Shares{KeyWidth'(32'hDEADBEEF)}}
  };

  localparam otbn_key_req_t OTBN_KEY_REQ_DEFAULT = '{
    valid: 1'b0,
