...
package flash_ctrl_pkg;
  ...
  localparam int NumSeeds = 2;
  localparam bit [0:0] CreatorSeedIdx = 0;
  localparam bit [0:0] OwnerSeedIdx = 1;
  localparam int SeedWidth = 256;
  localparam int KeyWidth  = 128;
  ...
  localparam keymgr_flash_t KEYMGR_FLASH_DEFAULT = '{
    seeds: '{
